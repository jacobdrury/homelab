...
| Homepage | k8s | **First** GitOps app after Envoy; tiles use `*.lab` (media download stack in-cluster + Authentik; Jellyfin still transitional) — [gethomepage.dev](https://gethomepage.dev) |
